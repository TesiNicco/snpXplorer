          ...
          wellPanel(style = "background: #f2f2f2",
            ...
            column(6,
              ...
              div(dropdown(
                ...
                h5("Download the GWAS Catalog results for this region"),
                downloadButton("download_GWASCat", "Download All Results"),
              ), align = "center"),
            ),
            div(h6("ss"), style = "color: #f2f2f2", align = "center"),
            hr(),
            div(h3("Top SNPs info"), align = "center"),
            div(tableOutput('table'), align = "center", style = 'font-size:90%; overflow-x: scroll; overflow-y: scroll; height:300px'),
            ...
            div(tableOutput('gwascat_table'), align = "center", style = 'font-size:90%; overflow-x: scroll; overflow-y: scroll; height:300px'),
