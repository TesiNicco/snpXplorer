           ...
           tabPanel("Exploration",
                    ...
                    fluidRow(
                      ...
                      column(4,
                         ...
                         checkboxGroupInput("gwas_neuro", "Neurological traits", c("IGAP" = "IGAP", "proxy_AD" = "proxy_AD", "Autism" = "Autism", "Depression" = "Depression", "Ventricular volume" = "LVV"), inline = T),
                         ...
                         bsPopover("gwas_neuro", title='Neurological traits', content='IGAP: International Genomics of Alzheimers disease (AD, case-control GWAS) -- Proxy_AD: family history of AD', placement="right",trigger="hover", options = list(container = "body")),
                         ...
                         bsPopover("gwas_physio", title='Physiological traits', content='UKBaging: parental longevity', placement="right",trigger="hover", options = list(container = "body")),
                    ...
                    fluidRow(  
                      column(4,
                             wellPanel(
                               ...
                               h6("You can add additional tissues by selecting them on the box below. Selecting All tissues will display results of all GTEx tissues. It may take some time in case you select many tissues and the window-size is big, so please be patient."),
                               multiInput(inputId = "gtex_type_tb", label = "GTEx tissues", choices = c("Adipose_Subcutaneous", "Adipose_Visceral_Omentum", "Adrenal_Gland", "Artery_Aorta", "Artery_Coronary", 
                                                                                                     ...
                                                                                                     "Small_Intestine_Terminal_Ileum", "Spleen", "Stomach", "Testis", "Thyroid", "Uterus", "Vagina", "Whole_Blood", "All tissues"), selected = "Whole_Blood",
