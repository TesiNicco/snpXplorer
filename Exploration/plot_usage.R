...
snpxplorer_data = data.frame(date = c('21/01/26', '04/02/26', '18/02/26', '05/03/26', '27/03/26'),
    Exploration = c(272, 387, 579, 645, 740), 
    Haplotypes = c(34, 53, 69, 78, 97),
    PRS = c(32, 38, 58, 63, 67),
    Single_variant = c(182, 651, 690, 919, 1318),
    Batch_annotation = c(56, 65, 98, 141, 176))

# reshape the data for ggplot
snpxplorer_data_melted = melt(snpxplorer_data, id.vars = 'date', variable.name = 'Category', value.name = 'Count')

# set date as factor
snpxplorer_data_melted$date = factor(snpxplorer_data_melted$date, levels = c('21/01/26', '04/02/26', '18/02/26', '05/03/26', '27/03/26'))
